...
from HyperbolicGCN import hyperbolicGCN
...
class HyperbolicGCNSingle(nn.Module):
    def __init__(self, a_dim, v_dim, l_dim, n_dim, nlayers, nhidden, nclass, dropout, lamda, alpha, variant, return_feature, use_residue, 
        ...
        super(HyperbolicGCNSingle, self).__init__()
        ...
        setattr(self, "hyperbolicgconv", hyperbolicGCN(self.num_K, nhidden+1, nhidden+1, self.dropout, curvature))
