...
class IEMOCAPDataset(Dataset):
    ...
    def __init__(self, train=True):
        ...
        self.testVid = pickle.load(open('/data/dataset/IEMOCAP_features.pkl', 'rb'), encoding='latin1')

        _, _, self.roberta1, self.roberta2, self.roberta3, self.roberta4,\
        _, _, _, _ = pickle.load(open('/data/dataset/IEMOCAP/iemocap_features_roberta.pkl', 'rb'), encoding='latin1')
        '''
...
class MELDDataset(Dataset):
    ...
    def __init__(self, path, train=True):
        ...
        _, _, _, self.roberta1, self.roberta2, self.roberta3, self.roberta4, \
            ...
            = pickle.load(open("/data/dataset/meld_features_roberta.pkl", 'rb'), encoding='latin1')
